...
namespace MyList
{
    class Program
    {
        ...
        static public bool VerificareTestClass (TestClass tmp) // functie de test match pentru verificare functionalitate FindAll
        {
            if (tmp.X % 2 == 0)
                return true;
            else
        ...
        static public bool VerificareInt(int  tmp) // functie de test match pentru verificare functionalitate FindAll
        {
            if (tmp % 2 == 0)
                return true;
            else
